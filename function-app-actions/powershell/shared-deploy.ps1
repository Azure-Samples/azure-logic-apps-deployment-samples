...
Function RegisterRP {
    ...
    $registered = Register-AzResourceProvider -ProviderNamespace $ResourceProviderNamespace;
}
...
$resourceProviders = @("Microsoft.Web","Microsoft.Insights","Microsoft.Storage");
